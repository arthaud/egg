...
public class LexJava implements Serializable {
	...
	public void setTermCorps(String pack, Vector<String> incs) {
		...
		corpsTerm.append("  public T_" + nom + "(LEX_" + nom + " scanner ) {\n");
		...
		if (table.getDst()) {
			...
			corpsTerm.append("	public void setParent( IDstNode p){parent = p;}\n");
			corpsTerm.append("	public IDstNode getParent(){return parent;}\n");
			corpsTerm.append("  public void addChild(IDstNode node){}\n");
			corpsTerm.append("  public List<IDstNode> getChildren(){return null;}\n");
			corpsTerm.append("  public boolean isLeaf(){return true;}\n");

			// visit
			corpsTerm.append("  public void accept(IDstVisitor visitor){visitor.visit(this);}\n");
			...
			corpsTerm.append("  public void setMalformed(){malformed = true;}\n");
			corpsTerm.append("  public boolean isMalformed(){return malformed;}\n");
		}
		corpsTerm.append("	}\n");
	}
	...
	public String toString() {
		...
		for (Enumeration<SYMBOLE> e = table.getLexicaux().elements(); e.hasMoreElements();) {
			SYMBOLE s = (SYMBOLE) e.nextElement();
